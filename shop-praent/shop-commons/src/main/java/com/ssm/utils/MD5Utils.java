...
public class MD5Utils {
   ...
   /* public static String decrypt(String pswd) {
        ...
        *//**
         ...
         *
         *//*
        String newPassword = new SimpleHash(algorithmName, pswd, ByteSource.Util.bytes(SALT), HASH_ITERATIONS);
        return newPassword;
    }*/
